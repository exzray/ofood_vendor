...
public class ProductUpdateViewModel extends ViewModel {
    ...
    private final MutableLiveData<DocumentSnapshot> snapshot_product = new MutableLiveData<>();
    ...
    public void setSnapshotProduct(String uid) {
        Firebase
                .getDocumentProduct(uid)
                .get()
                .addOnSuccessListener(snapshot_product::setValue);
    }
    ...
    public LiveData<DocumentSnapshot> getSnapshotProduct() {
    ...
    public void doUpdateProduct() {
        ...
        product.setEnable(Helper.getBoolean(boolean_enable.getValue()));

        final DocumentSnapshot snapshot = snapshot_product.getValue();
        assert snapshot != null;

        Firebase
                .getDocumentProduct(snapshot.getId())
                .set(product)
